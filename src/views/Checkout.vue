        ...
        <table class="table text-light">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-end fs-5 align-middle">{{cartTotalPrice | currencyFilter}}</td>
            </tr>
    ...
    <div class="my-5 row justify-content-center" v-if="step === 3">
      <div class="col-lg-7 col-md-9 col-10">
        ...
        <div class="text-end fs-6 mb-2">
          <button class="btn btn-outline-warning me-3" @click="$router.push({name:'Products'})">繼續選購</button>
        </div>
      </div>
    </div>
